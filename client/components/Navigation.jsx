...
import { Menu, X, MapPin, LogOut, User, Building } from 'lucide-react';
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isLoggedIn ? (
              <>
                ...
                {isVenueOwner() && (
                  <Button asChild variant="outline" className="border-venue-indigo text-venue-indigo hover:bg-venue-indigo hover:text-white">
              ...
              <>
                <Button asChild variant="ghost" className="text-venue-indigo hover:text-venue-purple hover:bg-venue-lavender/50 transition-colors">
